function [Omega_est, final_nu_matrix, total_iterations, each_time_taken]  = ...
   ...
   for init_iter = 1:n_EMs %choose parfor instead of "for" loop if running on a multi core CPU
    ...
    time_start = cputime; % start measuring the time 
    ...
    each_time_taken(1,init_iter) = cputime - time_start;
