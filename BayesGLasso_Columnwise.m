function [Sig_save,C_save,lambda_save,omega_vector_save] = BayesGLasso_Columnwise(S,n,Sig,C,a_lambda,b_lambda,burnin,nmc)
...
%%% sample tau off-diagonal        
        ...
        lambda_prime = lambda^2;  mu_prime = min(lambda./Cadjust,10^12);
...
%%% sample Sig and C = inv(Sig)        
    ...
    omega_vector = C(tril(true(size(C)),-1));
